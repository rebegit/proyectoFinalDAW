    ...
    <!--.barra-->
        ...
        <?php  
            try {
                ...
                $sql = " SELECT *FROM `invitados` "; //consulta. Mismos nombres que tablas TIENE QUE TENER ESAS COMILLAS
        ...
        <?php   while(   $invitados = $resultado->fetch_assoc() ){ ?> 
            ...
            <li>
                <div class="invitado">
                    <a  class="invitado-info" href="#invitado<?php echo $invitados['invitado_id']?>"> <!--asi se enlaza imagen con biografia-->
            ...
            <div style="display:none;">
                ...
                <div class="invitado-info" id= "invitado<?php echo $invitados['invitado_id'] ?>" alt="Imagen invitado">
                    <img src="img/invitados/<?php echo $invitados['url_imagen'] ?>" alt="Imagen invitado">
    ...
    <footer class="site-footer">
        <div class="contenedor clearfix">
            ...
            <div class="ultimos-tweets">
                ...
                <a class="twitter-timeline" data-height="400" data-theme="light" data-link-color="#fe4918" href="https://twitter.com/ReyLeonMusical?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor">Tweets by Rebeca</a>
